...
trait TencentLBS{
    ...
    static function getLocation()
    {
        ...
        $url = $geocodeUrl."$latitude,$longitude&key=".config('wechat.lbsqq.key');
    ...
    static function Search($name)
    {
        ...
        $url = $searchUrl."keyword=$name&boundary=nearby($latitude,$longitude,1000)&key=".config('wechat.lbsqq.key')."&page_size=10";
